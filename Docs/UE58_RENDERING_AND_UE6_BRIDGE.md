...
**Runtime target:** Windows + Linux Alpha, 60 fps gameplay floor.  
...
Higgsfield output is also reference/previs, not an Unreal executable or shipping animation asset. Provider-generated motion must be retargeted/rebuilt and accepted in-engine.
