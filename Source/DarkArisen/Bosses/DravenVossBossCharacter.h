...
/** Final physical Draven encounter on the Black Deck. */
UCLASS()
...
public:
    ...
    UPROPERTY(BlueprintReadOnly,Category="Draven") int32 CombatPhase=1;
private:
    UFUNCTION() void HandleDravenHealthChanged(float NewHealth,float MaximumHealth,float Delta);
