...
- Added the exact authored forty-person Las Raíces roster at the locked 16/12/8/4 cultural split, stable identities, professions, local mission knowledge and four purpose anchors per resident. A level-placeable director spawns only the validated roster; resident actors fail initialization with health/combat components, and all five children add zero-damage, zero-launch and no-physics protections. Non-colliding settlement anchors accept path requests from the future canonical time owner and fail closed on duplicate/missing anchors or unsheltered midday destinations. A sparse combat-proximity subsystem now drives exact-50 m child flight, immediate fail-safe removal on bad routing, persistent-combat sheltering and protected restoration; its undocumented timings remain `DESIGN-GAP`. Final level/anchor placement, observed navigation/safety, adult reactions, four ambient-dialogue layers and UE runtime evidence remain open.
